export const Icons = {
  ...
  quotation: {
    ...
    class:
      "absolute left-2 top-0 h-10 w-10 text-orange-300 dark:text-neutral-700 opacity-70",
    width: 16,
    height: 16,
    viewBox: "0 0 16 16",
    fill: "currentColor",
  ...
  globe: {
    paths: [
      ...
      {
        d: "M12 3a4.5 4.5 0 0 1 0 18 4.5 4.5 0 0 1 0-18z",
      },
    ],
    class: "w-4 h-4 shrink-0",
    viewBox: "0 0 24 24",
  ...
  truck: {
    paths: [
      {
        d: "M864 320H672v-64c0-17.6-14.4-32-32-32H160c-17.6 0-32 14.4-32 32v384c0 17.6 14.4 32 32 32h32c0 53 43 96 96 96s96-43 96-96h256c0 53 43 96 96 96s96-43 96-96h32v-192l-96-160zM288 736c-35.3 0-64-28.7-64-64s28.7-64 64-64 64 28.7 64 64-28.7 64-64 64zm128-224H192V288h224v224zm288 224c-35.3 0-64-28.7-64-64s28.7-64 64-64 64 28.7 64 64-28.7 64-64 64zm96-224h-96V384h49.1l46.9 78.1V512z",
      },
    ],
    class: "mt-1 h-12 w-12 shrink-0 fill-orange-400 dark:fill-orange-300",
    width: 1024,
    height: 1024,
  ...
  map: {
    paths: [
      {
        d: "M512 327.7c-54.8 0-99.3 44.5-99.3 99.3 0 54.8 44.5 99.3 99.3 99.3 54.8 0 99.3-44.5 99.3-99.3 0-54.8-44.5-99.3-99.3-99.3z",
      },
      {
        d: "M512 128c-165.4 0-299.5 134.1-299.5 299.5 0 224 299.5 468.5 299.5 468.5s299.5-244.5 299.5-468.5c0-165.4-134.1-299.5-299.5-299.5z m0 498.9c-110.1 0-199.4-89.3-199.4-199.4s89.3-199.4 199.4-199.4 199.4 89.3 199.4 199.4-89.3 199.4-199.4 199.4z",
      },
    ],
    class: "mt-1 h-10 w-10 shrink-0 fill-orange-400 dark:fill-orange-300",
    width: 1024,
    height: 1024,
    viewBox: "0 0 1024 1024",
    fill: "currentColor",
  ...
  list: {
    paths: [
      ...
      {
        d: "M192 232c0 22.1-17.9 40-40 40s-40-17.9-40-40 17.9-40 40-40 40 17.9 40 40zM192 516c0 22.1-17.9 40-40 40s-40-17.9-40-40 17.9-40 40-40 40 17.9 40 40zM192 800c0 22.1-17.9 40-40 40s-40-17.9-40-40 17.9-40 40-40 40 17.9 40 40z",
      },
    ],
    class: "mt-1 h-10 w-10 shrink-0",
    width: 1024,
  ...
  facebookContact: {
    ...
    class: "mt-1.5 h-5 w-5 shrink-0 text-neutral-600 dark:text-neutral-400",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  socialMedia: {
    ...
    class: "h-6 w-6 shrink-0 text-neutral-600 dark:text-neutral-400",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  recycle: {
    paths: [
      {
        d: "M866.9 746.6 621.6 501.3l90.2-90.2c31.7 25.1 69.4 42.7 110.3 49.6 23.3 3.9 46.2-10.2 50.1-33.5 3.9-23.3-10.2-46.2-33.5-50.1-27.4-4.6-53.2-15.5-75.3-32.1l146.7-146.7c18.7-18.7 18.7-49.1 0-67.9-18.7-18.7-49.1-18.7-67.9 0L695.4 277.3c-16.6-22-27.5-47.8-32.1-75.3-3.9-23.3-26.8-37.4-50.1-33.5-23.3 3.9-37.4 26.8-33.5 50.1 6.9 40.9 24.4 78.6 49.6 110.3l-90.2 90.2-245.3-245.3c-18.7-18.7-49.1-18.7-67.9 0-18.7 18.7-18.7 49.1 0 67.9l245.3 245.3-90.2 90.2c-31.7-25.1-69.4-42.7-110.3-49.6-23.3-3.9-46.2 10.2-50.1 33.5-3.9 23.3 10.2 46.2 33.5 50.1 27.4 4.6 53.2 15.5 75.3 32.1L183.1 790c-18.7 18.7-18.7 49.1 0 67.9 18.7 18.7 49.1 18.7 67.9 0l146.7-146.7c16.6 22 27.5 47.8 32.1 75.3 3.9 23.3 26.8 37.4 50.1 33.5 23.3-3.9 37.4-26.8 33.5-50.1-6.9-40.9-24.4-78.6-49.6-110.3l90.2-90.2 245.3 245.3c18.7 18.7 49.1 18.7 67.9 0 18.6-18.7 18.6-49.1-.3-67.9z",
      },
    ],
    class: "mt-1 h-8 w-8 shrink-0 fill-orange-400 dark:fill-orange-300",
    width: 1024,
  ...
  diploma: {
    ...
    class: "mt-1 h-8 w-8 shrink-0 fill-white dark:fill-white hs-tab-active:fill-orange-400 dark:hs-tab-active:fill-orange-300",
    width: 384,
    height: 512,
    viewBox: "0 0 384 512",
    fill: "currentColor",
